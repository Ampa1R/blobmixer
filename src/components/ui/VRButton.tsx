...
export default function VRButton({ gl }) {
  ...
  return (
    <div className={s.position} id="VRButton">
      {!isSupported && (
      ...
      {isSupported && (
        <button className={s.button} ref={button} onClick={toggleVR}>
          {message}
        </button>
      )}
    </div>
